...
urlpatterns = [
    ...
    path("booking/contact/<str:pk>/edit", views.EditContactBookingView.as_view(), name="edit_contact_booking"),
    path("booking/dates/<str:pk>/edit", views.EditDatesBookingView.as_view(), name="edit_dates_booking"),
