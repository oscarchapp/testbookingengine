...
urlpatterns = [
    ...
    path("booking/<str:pk>/editdates", views.EditBookingDatesView.as_view(), name="edit_booking_dates"),
    ...
    path("dates/available", views.checkDatesView.as_view(), name="check_dates_booking"),
