...
urlpatterns = [
    ...
    path(
        "booking/customer/<str:pk>/edit",
        views.EditBookingCustomerView.as_view(),
        name="edit_booking",
    ),
    path(
    ...
    path("search/rooms/", views.RoomsSearchView.as_view(), name="rooms_search"),
    path("booking/<str:pk>/edit", views.EditBookingView.as_view(), name="booking_edit"),
]
