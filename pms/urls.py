...
urlpatterns = [
    ...
    path("booking/<str:pk>/editdate", views.EditDateBookingView.as_view(), name="edit_booking_date"),
    path("booking/<str:pk>/valid_change", views.ValidDateBookingView.as_view(), name="valid_change"),
