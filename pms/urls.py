...
urlpatterns = [
    ...
    path("booking/<str:pk>/edit", views.EditBookingView.as_view(), {'edit_type': None}, name="edit_booking"),
    path("booking/<str:pk>/edit/<str:edit_type>", views.EditBookingView.as_view(), name="edit_booking"),
