...
urlpatterns = [
    ...
    path("filter/room/",views.RoomsSearchedView.as_view(),name = "room_search"),
    ...
    path("booking/date/<str:pk>/edit",views.EditBookingDateView.as_view(),name = "edit_booking_date"),
